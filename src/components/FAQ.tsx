...
const FAQS = [
  ...
  },
  {
    ...
    a: "EXO ($75) is the peak of what we secure — heavy hitters reserved for serious connoisseurs. AAA ($70) is still premium, small-batch flower from trusted legacy operators. Different pedigrees, same standard.",
  },
  {
