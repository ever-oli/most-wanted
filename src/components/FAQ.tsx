...
const FAQS = [
  ...
  },
  {
    ...
    a: "EXO ($110) is the peak of what we secure — heavy hitters reserved for serious connoisseurs. AAA ($75) is still premium, small-batch flower from trusted legacy operators. Different pedigrees, same standard.",
  },
  {
