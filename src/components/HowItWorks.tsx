...
const steps = [
  ...
  { icon: Sparkles, title: "Keep Your Cuts", body: `AAA, EXO, or the rare Reserve exclusive — cuts worth $70 to $100. After your spins, keep only the jars you want and pay one flat $${WILDCARD_PRICE} each. Land the Reserve and the jackpot lights up.` },
  { icon: Package, title: "Rip the Pack", body: "Discreet, odor-sealed, no branding. Tracking hits your inbox the second it ships. Every jar arrives with a unique review code." },
  { icon: Star, title: "Rate & Rank", body: "Scan the review code on your jar to log your verdict on the 5-point Ganjier scale. Verified verdicts join the public Archive and climb the Most Wanted Hunters board. Earn your name." },
];
